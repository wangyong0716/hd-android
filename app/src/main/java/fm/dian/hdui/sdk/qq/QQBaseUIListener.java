...
public class QQBaseUIListener implements IUiListener {
    private AuthCompleteListener mCompleteListener;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ON_COMPLETE:
                    ...
                    Util.dismissDialog();
                    mCompleteListener.authComplete();
                    break;
                case ON_ERROR:
    ...
    public QQBaseUIListener(Context mContext, AuthCompleteListener completeListener) {
        super();
