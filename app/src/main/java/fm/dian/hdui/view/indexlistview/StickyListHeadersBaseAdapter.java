...
public abstract class StickyListHeadersBaseAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    /**
     * @param position    list item's position in list, NOT the index of the header
     * @param convertView a reused view, use this if not null
     * @return the header for list item at position
     */
    ...
    /**
     * @param position    list item's position in list.
     * @param convertView a reused view, use this if not null
     * @return the list item at position
     */
    ...
    /**
     * @internal used by the StickyListHeadersListView, set the divider and divider height via listview instead!
     */
